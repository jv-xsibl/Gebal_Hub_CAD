...
- Output root: `C:\Users\jvsin\Documents\GitHub\Gebal_Hub_CAD\tests\output\cad_variation_audit_generic`
...
- Ambiguous/review-required layer assignments: 166
...
- `Example2/137225M` layer `ASHADE` -> `ambiguous`: low-confidence classification
- `Example2/137225M` layer `Lg_area` -> `review_required`: insufficient evidence
- `Example2/137225M` layer `Lg_boundary` -> `ambiguous`: low-confidence classification
